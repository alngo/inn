...
use crate::application::shared::UseCase;
...
pub trait InnService {
    ...
    ) -> Result<create_owner::Response, anyhow::Error>;
}
...
mod service_tests {
    use super::*;
    use crate::{
        application::inn::owner::{create_owner, MockOwnerRepository},
        domain::{Owner, OwnerName},
    };
