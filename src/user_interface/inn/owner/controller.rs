use crate::{application::inn::{owner::create_owner, service::InnService}, user_interface::shared::Present};
    ...
    P: Present<create_owner::Result>
{
    ...
    pub async fn create_owner(&self, name: &str) {
        let result = self.service.create_owner(&create_owner::Request { name: name.to_string() }).await;
